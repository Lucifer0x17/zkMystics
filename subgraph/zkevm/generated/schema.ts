...
export class ZkMystics__CheckStatusRequestCreatedUsingChainlink extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save ZkMystics__CheckStatusRequestCreatedUsingChainlink entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type ZkMystics__CheckStatusRequestCreatedUsingChainlink must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set(
  ...
  static loadInBlock(
    id: Bytes
  ): ZkMystics__CheckStatusRequestCreatedUsingChainlink | null {
    return changetype<ZkMystics__CheckStatusRequestCreatedUsingChainlink | null>(
      store.get_in_block(
        "ZkMystics__CheckStatusRequestCreatedUsingChainlink",
        id.toHexString()
      )
...
export class ZkMystics__NFTMinted extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ZkMystics__NFTMinted entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type ZkMystics__NFTMinted must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ZkMystics__NFTMinted", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): ZkMystics__NFTMinted | null {
    return changetype<ZkMystics__NFTMinted | null>(
      store.get_in_block("ZkMystics__NFTMinted", id.toHexString())
    );
  }

  static load(id: Bytes): ZkMystics__NFTMinted | null {
    return changetype<ZkMystics__NFTMinted | null>(
      store.get("ZkMystics__NFTMinted", id.toHexString())
    );
  }
...
export class ZkMystics__StatusFailed extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save ZkMystics__StatusFailed entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type ZkMystics__StatusFailed must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ZkMystics__StatusFailed", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): ZkMystics__StatusFailed | null {
    return changetype<ZkMystics__StatusFailed | null>(
      store.get_in_block("ZkMystics__StatusFailed", id.toHexString())
    );
  }

  static load(id: Bytes): ZkMystics__StatusFailed | null {
    return changetype<ZkMystics__StatusFailed | null>(
      store.get("ZkMystics__StatusFailed", id.toHexString())
    );
  }
